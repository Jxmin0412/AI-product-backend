...
from api.auth.responses import (
    ...
    LoginSessionsListResponse,
)
from api.auth.dependencies import get_current_user, get_refresh_token_from_cookie
...
async def get_login_sessions(
    ...
    sessions = auth_service.get_user_login_sessions(
