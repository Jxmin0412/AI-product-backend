"""Authentication service - business logic and DB communication."""
...
class AuthService:
    ...
    def create_login_session(
        ...
        """Create a new login session for tracking."""
    ...
    def end_login_session(self, user_id: str) -> None:
        """End all active login sessions for a user."""
    ...
    def get_all_login_sessions(
        self,
        limit: int = 100,
        offset: int = 0
    ) -> List[LoginSession]:
        """Get all login sessions (admin view)."""
